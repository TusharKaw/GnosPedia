...
$wgScribuntoEngineConf['luastandalone'] = [
    'class' => 'MediaWiki\Extension\Scribunto\Engines\LuaStandalone\LuaStandaloneEngine',
    'luaPath' => '/usr/bin/luajit', // or '/usr/bin/lua' if LuaJIT not installed
    'memoryLimit' => 500000000,     // 500MB
    'cpuLimit' => 30,
    'maxLangCacheSize' => 30,
    'enableDebug' => true,
...
# Give sysops import permissions
$wgGroupPermissions['sysop']['import'] = true;
$wgGroupPermissions['sysop']['importupload'] = true;

# Optional: allow regular users to import
$wgGroupPermissions['user']['import'] = true;
$wgGroupPermissions['user']['importupload'] = true;

# Allow XML uploads for importing pages
$wgFileExtensions = array_merge($wgFileExtensions, ['xml']);
$wgMaxUploadSize = 1024 * 1024 * 200; // 200MB
...
# SVG rendering setup
$wgSVGConverters = [
    'ImageMagick' => '/usr/bin/convert -background transparent -resize ${width}x${height} -o $output $input',
];
...
wfLoadSkin( 'Vector' );
$wgDefaultSkin = "vector";   // make the default skin
